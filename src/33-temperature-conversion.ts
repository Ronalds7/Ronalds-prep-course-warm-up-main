 ...
 *
 * Temperature should be rounded to one decimal place: i.e., fahrenheitToCelsius(100)
 * should return 37.8 and not 37.77777777777778.
 */


const fahrenheitToCelsius = (a: number) => (a - 32) * 5 / 9;
const celsiusToFahrenheit = (b: number) => b * 9 / 5 + 32;
